...
/** How Sarah's joined events split across the pillars. */
export const volunteerFocusSplit = [
  { focus: "cleaning", events: 8, fill: "var(--color-cleaning)" },
  { focus: "volunteering", events: 3, fill: "var(--color-volunteering)" },
  { focus: "spreading", events: 1, fill: "var(--color-spreading)" },
];
