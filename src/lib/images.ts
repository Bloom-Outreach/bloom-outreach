...
export const siteImages = {
  ...
  aboutStory: {
    src: unsplash(CLEANING[0], 1200, 900),
  ...
  auth: {
    signIn: {
      src: unsplash(VOLUNTEERING[3], 1600, 2000),
      alt: "Bloom Outreach volunteers serving their community",
      width: 1600,
      height: 2000,
    },
    signUp: {
      src: unsplash(VOLUNTEERING[0], 1600, 2000),
      alt: "Hands joined together in volunteer service",
      width: 1600,
      height: 2000,
    },
    forgot: {
      src: unsplash(GOSPEL[2], 1600, 2000),
  ...
  pageHeaders: {
    about: unsplash(VOLUNTEERING[2], 1600, 900),
    ...
    calendar: unsplash(VOLUNTEERING[3], 1600, 900),
