          ...
          <FadeIn delay={0.1}>
            ...
            <div className="mt-6 space-y-4 text-lg leading-relaxed text-muted-foreground">
              <p>
                ...
                believers committed to volunteering, cleaning our neighborhoods,
              ...
              <p>
                ...
                practical love and the message of Christ belong in every
                community.
              </p>
              <p>
        ...
        <FadeIn>
          ...
          >
            <div className="px-8 py-16 text-center md:px-16 md:py-20">
              <Badge
                variant="outline"
                className="mb-5 border-white/25 text-white"
              >
                Ready to Give?
              </Badge>
