				...
				<div className="grid items-center gap-12 lg:grid-cols-2 lg:gap-16">
					...
					<FadeIn delay={0.1}>
						...
						<div className="mt-6 space-y-4 text-lg leading-relaxed text-muted-foreground">
							<p>
								Bloom Outreach began when a small group of believers asked a simple
								question: how can we serve our community for Jesus? The answer was
								clear — volunteer together, clean our neighborhoods, and spread the
								word of God.
							</p>
							<p>
							...
							<p>
								...
								nurtured, lives and communities flourish when touched by the love of
								Christ — through volunteering, cleaning, and spreading His word.
							</p>
						</div>
					</FadeIn>
				</div>
