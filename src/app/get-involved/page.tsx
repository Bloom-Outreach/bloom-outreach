...
const steps = [
	{
		...
		description: "Fill out our interest form or come to a cleanup day to get started.",
	},
	{
		icon: Calendar,
					...
					<Card className="flex flex-col items-center gap-6 overflow-hidden bg-gradient-to-br from-card to-muted/40 text-center md:flex-row md:text-left">
						...
						<div className="flex-1">
							...
							<p className="mt-2 text-muted-foreground">
								Reach out and we&apos;ll help you find the perfect way to serve. No
								commitment required — just a conversation.
							</p>
						</div>
