...
export function ProfileSidebar() {
	const { firstName, lastName, email, role, memberSince, avatar, focus } = mockVolunteer;
			...
			<div className="relative px-6 pb-6">
				...
				<div className="text-center">
					...
					<div className="mt-3 flex flex-wrap items-center justify-center gap-2">
						<Badge variant="soft">Volunteer</Badge>
					</div>
					<p className="mt-3 text-xs text-muted-foreground">Member since {memberSince}</p>
				</div>
